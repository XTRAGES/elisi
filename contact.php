...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['firstlastname'], $_POST['email'], $_POST['subject'], $_POST['message'])) {
        ...
        if (empty($firstlastname) || empty($email) || empty($subject) || empty($message)) {
        ...
        $stmt = $conn->prepare("INSERT INTO contact (firstlastname, email, subject, message) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $firstlastname, $email, $subject, $message);
            ...
            <div class="col-12">
                <div class="row gy-4">
                    <div class="col-md-4">
                        ...
                        <p><i class="fa fa-envelope-open text-primary me-2"></i>book@elisi.com</p>
                    </div>
                    <div class="col-md-4">
                        <h6 class="section-title text-start text-primary text-uppercase">General</h6>
                        <p><i class="fa fa-envelope-open text-primary me-2"></i>general@elisi.com</p>
                    </div>
                    <div class="col-md-4">
                        <h6 class="section-title text-start text-primary text-uppercase">Technical</h6>
                        <p><i class="fa fa-envelope-open text-primary me-2"></i>tech@elisi.com</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="name" name="firstlastname" placeholder="Your Name">
